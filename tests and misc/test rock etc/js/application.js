...
//below, but I wanted a number range divisible by 3
...
var kittenMode = function() {
	...
	$(document).keydown(function(event) {
    	...
    	//above is so you can hit return on confirm instead of  
    	//having to select OK(it takes return out of the "any 
    	//button" group)
